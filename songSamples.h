...
/* The imperial march - Star Wars Darth Vader's Theme (composed by John Williams) */
const Note_t IMPERIAL_MARCH[] = {
    { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, QUARTER_DOT }, { PAUSE, EIGHTH },
    { RE4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { RE4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { RE4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf4, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, QUARTER_DOT }, { PAUSE, EIGHTH },
    { SOL4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOL3, EIGHTH_DOT }, { SOL3, SIXTEENTH }, { SOL4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOLf4, EIGHTH_DOT }, { FA4, SIXTEENTH }, { MI4, SIXTEENTH }, { REs4, SIXTEENTH }, { MI4, EIGHTH },
    { PAUSE, EIGHTH }, { SOLs3, EIGHTH }, { DOs4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SIs3, EIGHTH_DOT }, { SI3, SIXTEENTH }, { SIf3, SIXTEENTH }, { LA3, SIXTEENTH }, { SIf3, EIGHTH },
    { PAUSE, EIGHTH }, { MIf3, EIGHTH }, { SOLf3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SOLf3, SIXTEENTH }, { SIf3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOL3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { RE4, QUARTER_DOT }, { PAUSE, EIGHTH },
    { SOL4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOL3, EIGHTH_DOT }, { SOL3, SIXTEENTH }, { SOL4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SOLf4, EIGHTH_DOT }, { FA4, SIXTEENTH }, { MI4, SIXTEENTH }, { REs4, SIXTEENTH }, { MI4, EIGHTH },
    { PAUSE, EIGHTH }, { SOLs3, EIGHTH }, { DOs4, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { SIs3, EIGHTH_DOT }, { SI3, SIXTEENTH }, { SIf3, SIXTEENTH }, { LA3, SIXTEENTH }, { SIf3, EIGHTH },
    { PAUSE, EIGHTH }, { MIf3, EIGHTH }, { SOLf3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, EIGHTH_DOT_DOT }, { PAUSE, THIRTYSECOND }, { MIf3, EIGHTH_DOT }, { SIf3, SIXTEENTH }, { SOL3, QUARTER_DOT }, { PAUSE, EIGHTH },
    { END, 0 }
};

const Note_config_t IMPERIAL_MARCH_CONFIG[] = {
    { 1, MEDIUM, FORTE },
    { END_CONFIG, 0, 0 }
};
